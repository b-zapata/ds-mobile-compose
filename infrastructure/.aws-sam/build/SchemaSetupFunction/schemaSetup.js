...
// src/schemaSetup.ts
var schemaSetup_exports = {};
__export(schemaSetup_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(schemaSetup_exports);
...
`;
async function sendResponse(responseUrl, status, reason, data, event) {
...
var handler = async (event) => {
  ...
  try {
    ...
    const client = new Client({
      ...
      ssl: getEnvOrThrow("DB_SSL") === "true" ? { rejectUnauthorized: false } : void 0
    });
    try {
...
//# sourceMappingURL=schemaSetup.js.map
